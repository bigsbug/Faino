    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default=faino.AuthSystem.models.Confirm_User.random_code, max_length=8, unique=True)),
                ('token', models.UUIDField(default=uuid.uuid4, unique=True)),
                ('expire', models.DateTimeField(default=faino.AuthSystem.models.Confirm_User.expire_time)),
            ],
        ),
        migrations.CreateModel(
            name='Permissions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expire', models.DateTimeField(default=faino.AuthSystem.models.Temp_link.expire_time)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ManyToManyField(related_name='Permissions_of_group', to='AuthSystem.permissions')),
            ],
        ),
