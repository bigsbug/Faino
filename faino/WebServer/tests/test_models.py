...
from faino.WebServer.models import Device, Type, Data, Command, Button, Source_Device
...
class SourceDeviceTestCase(TestCase):
    def setUp(self) -> None:
        ...
        self.file = SimpleUploadedFile(
            "Source-File.bin", b"my source device version 0.2"
        )
        self.vesrion = "0.2"
        return super().setUp()
    ...
    def test_make_new_source(self):
        new_source = Source_Device(
            type=self.type, version=self.vesrion, source=self.file
        )
